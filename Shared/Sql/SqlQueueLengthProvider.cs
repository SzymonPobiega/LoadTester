...
{
    class SqlQueueLengthProvider : IProvideQueueLength
    {
        public void ConfigureEndpoint(RawEndpointConfiguration configuration)
        {
        ...
        public void Initialize(string connectionString, Action<QueueLengthEntry[], EndpointToQueueMapping> store)
        {
            this.connectionString = connectionString ??
                                    "data source=(local); initial catalog=perf_test; integrated security=true";
        ...
        static ILog Logger = LogManager.GetLogger<SqlQueueLengthProvider>();
